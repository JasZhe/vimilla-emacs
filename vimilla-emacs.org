...
*** behaving more like corfu and stuff
https://www.rahuljuliato.com/posts/in-buffer-icomplete

Apply this patch to /usr/local/share/emacs/30.0.91/lisp/icomplete.el or basically wherever help->some-icomplete-function points to in the help buffer where it links to icomplete.el

then run byte-compile-file
...
:ALTERNATIVE_HACKY_APPROACH:
Just eval a new icomplete--render-vertical
#+begin_src elisp :tangle no

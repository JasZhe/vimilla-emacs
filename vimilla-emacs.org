...
#+PROPERTY: header-args :tangle yes :comments link :mkdirp yes :results silent

* TODO clean things up ask for feedback on reddit?

* TODO flesh out some org commands

* TODO use this on some actual coding project
maybe clojure stuff
maybe something in rust since rust-ts-mode is built in

* TODO look into using emacsclient for git rebase and stuff
something like this
#+begin_src elisp :tangle no
  ...
  example usage: (my/vc-git-editor-command \"rebase -i HEAD~3\""
      (async-shell-command "GIT_EDITOR=\"emacsclient\" bash -c \"git rebase -i HEAD~3\""))
#+end_src
...
* Viper
:PROPERTIES:
:header-args: :tangle ~/.emacs.d/viper :comments link :results silent
:END:
...
** TODO advise viper-brac/ket-function
holy shit lol..
